 ...
 *
 * limina: venus snapshot-replay re-creation journal (limina M9.3 seamless resume).
 *
...
/* limina snapshot-replay: pin a key so its entries survive the object's death —
