...
struct vkr_ring {
   ...
   /* limina present-fence barriers (#8): each node waits for the ring thread to
...
/* limina (#8): register a present-fence barrier at the ring's current guest tail.
