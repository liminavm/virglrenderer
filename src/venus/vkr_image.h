...
struct vkr_image {
   ...
   /* limina: the VkFormat this image was created with. The MTLTEXTURE import path needs it
   ...
   uint32_t limina_vk_format;
};
VKR_DEFINE_OBJECT_CAST(image, VK_OBJECT_TYPE_IMAGE, VkImage)

/* limina: VkFormat -> MTLPixelFormat, preserving sRGB (unlike the IOSurface mapper, which
