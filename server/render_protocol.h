...
struct render_context_op_create_resource_reply {
   ...
   /* limina tier-2 (macOS): global IOSurface id backing this scanout blob, or 0. Threaded
   ...
   /* limina tier-2 (macOS) #28: for a HOST_VISIBLE blob, the host VA of MoltenVK's own mapping
